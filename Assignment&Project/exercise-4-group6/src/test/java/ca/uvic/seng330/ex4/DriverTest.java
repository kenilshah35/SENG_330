...
class AppTest {
    ...
    @BeforeAll public void Init()
    {
        ...
        whaleList.add(new Whale(Whale.WhaleSpecies.SPERM_WHALE, "Young Male with injury to right fin"));
        ...
        Observation ob1 =  new Observation(48.1, 124.2, platform1, new Date(2020, 12, 05), Cardinal.NORTH, whaleList, 25,
                reporter1, "observation1");
        Observation ob2 = new Observation(50.2, 60.6, platform1, new Date(2019, 11, 03), Cardinal.EAST, whaleList, 25,
                reporter1, "observation2");
        Observation ob3 = new Observation(80.3, 90.2, platform1, new Date(2020, 5, 04), Cardinal.WEST, whaleList, 25,
                reporter2, "observation3");
    ...
    @Test public void SortWorks()
    {
        ...
        assertArrayEquals(observations.toArray(), sortedTimeObs.toArray(), "array is incorrectly sorted by time");
    }

    @Test public void SearchWorks()
    {
    ...
    @Test public void MultipleStrategies()
    {
        SearchObservation obs = new SearchObservation(log.getObservationLog());
