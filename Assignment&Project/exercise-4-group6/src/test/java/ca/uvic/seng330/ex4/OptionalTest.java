...
public class OptionalTest {
    ...
    @Test void testNullAutoConversion() {
    ...
    @Test void testWhaleConstructionExceptions() {
        assertThrows(NullPointerException.class, () -> {
            new Whale(null, "5/7 whale");
        });
    }

    @Test void testObservationConstructionExceptions() {
        assertThrows(NullPointerException.class, () -> {
        ...
        assertThrows(NullPointerException.class, () -> {
            Observation ob =  new Observation(
                    48.1,
                    124.2,
                    new SightingPlatform(SightingPlatform.SightingPlatformType.AIRPLANE),
                    new Date(2020, 12, 5),
                    Cardinal.NORTH,
                    null,
                    25,
