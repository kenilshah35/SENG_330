...
{
  private final Slider aSlider = createSlider();
...
{
  private final TextField aText = new TextField();
  private final Model aModel;
...
class Model
{
  ...
  private final ArrayList<Observer> aObservers = new ArrayList<Observer>();
